...
final class CourseRegistrationModelManagerImpl
    ...
    protected void updateDatabaseFields(CourseRegistrationModelImpl entityOld, CourseRegistrationModelImpl entityNew) {
        ...
        entityOld.setCurrentlyAssignedToTeamField(entityNew.isCurrentlyAssignedToTeamField());
    }

    @Override
    protected void updateAutogeneratedFields(CourseRegistrationModelImpl entityOld, CourseRegistrationModelImpl entityNew) {
